...
alert("Hello there, " + name + ", aged " + age + "! Now, if you ever want to ask me any questions or tell me something, you can always click the button that is labelled 'TALK TO THE AI'. I hope to talk to you more today! :)");
        ...
        function respond() {
            ...
            output = ["Hey!", "Hey!", "Hi there!", "i Hello.", "You're leaving? Ok then :( it was fun talking to you! Bye!!", "You're leaving? Ok then :( it was fun talking to you! Bye!!", "??? What do you mean, no?", "??? I am equally as confused as you are.", "I am confused.", "I am the AI.", "To Isengard!", "Are you talking about me? Gee, thanks so much! :) That made me feel 381.34 times better!", "Aww :'( I've been trying to get your approval. Oh well", "WE LIKE TO PARTY....WE LIKE TO, WE LIKE TO PARTY!", "You speak in numbers?", "Umm. Numbers mean nothing in this context.", "Come on, do not talk to me in numbers.", "I do m not get this. Are you writing an encrypted message?", "Numbers? Do you talk with numbers?", "Your message is interesting.", "I cannot understand this. Why do you write this number?", "eeehhhhh. Is that an english word?", "Numberese. A new language I shall never master.", "Numbers mean nothing in this context."];
